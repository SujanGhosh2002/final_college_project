        ...
        <form class="signup-form" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group form-group-flex">
                ...
                <label for="">your password<br>
                    <input type="password" name="pass" class="form-input" placeholder="enter your password">
                </label>
            </div>
            <div class="form-group form-group-flex">
                ...
                <label for="">confirm password<br>
                    <input type="password" name="cpass" class="form-input" placeholder="enter your password">
                </label>
            </div>
